		...
		<div className='page'>
			...
			<span className='intro3 white' style={{ marginTop: "0rem", paddingTop: "5rem" }}>
				...
				<div className='course-cards'>
					...
					<div className='card'>
						<h3 style={{ color: "blue", marginBottom: "1rem" }}>View All Courses</h3>
			...
			<footer className='footer'>
				<div className="footer-upper">
					<div className='big-col'>
						...
						<div className="playstore" >
							<a href="https://play.google.com/store/apps/dev?id=8227237868464522664&referrer=utm_campaign%3Dprogramiz-footer%26utm_source%3Dprogramiz-website">
								<img src='https://texttofloss.com/wp-content/uploads/2021/01/Google-Play-Store-Button.png' alt='play store link' height='100px' width='300px' />
							</a>
						</div>
						<div className="appstore">
							<a href="https://www.apple.com/in/search/programiz?src=globalnav">
								<img src='https://upload.wikimedia.org/wikipedia/commons/5/5d/Available_on_the_App_Store_%28black%29.png' alt='app store link' height='100px' width='300px' />
							</a>
						</div>
					...
					<div className='col'>
						<h3>Tutorial</h3>
						{
							footerCourse.map((course) => {
								return (
									<p className='tut'>{course}</p>
								);
							})
						}
					</div>
				...
				<div className='last'>
					<small>&copy; Copyright {currentYear}, Bhagya Website.All rights reserved</small>

					<div className='socials'>
						<div>
							<a href="https://www.linkedin.com/in/bhagya-patel-9836081b7/">
								<img src={linkdin} alt='app store link' height='30px' width='30px' />
							</a>
						</div>
						<div>
							<a href="https://github.com/bhagyaspatel">
								<img src={github} alt='app store link' height='30px' width='30px' />
							</a>
						</div>
						<div>
							<a href="https://www.instagram.com/_bhagya_patel_09/">
								<img src={instagram} alt='app store link' height='30px' width='30px' />
							</a>
						</div>
					</div>
				</div>
